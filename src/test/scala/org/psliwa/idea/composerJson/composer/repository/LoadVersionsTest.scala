...
class LoadVersionsTest {
  ...
  def loadFromPackagist_givenValidPackage_expectSomeVersions() = {
    val result = Packagist.loadVersions(Packagist.defaultUrl)("symfony/symfony")
  ...
  def loadFromPackagist_givenInvalidPackage_expectError() = {
    val result = Packagist.loadVersions(Packagist.defaultUrl)("some-unexisting-vendor/some-unexisting-package-123")
