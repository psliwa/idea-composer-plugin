...
import org.psliwa.idea.composerJson.composer.model.version.VersionSuggestions.SimplifiedVersionConstraint.{
  NonSemantic,
  PrefixedSemantic,
  PureSemantic,
  Wildcard
...
class VersionComparatorTest {
  ...
  def sortVersions(): Unit = {
    ...
    assertEquals(List("1.1.0", "1.0.*", "1.0.100", "1.0.0", "1.*", "1.2", "1.1", "v1.1.0", "dev-master", "1.1.x-dev"),
                 sortedVersions)
  }
